<div class="w-[1980px] h-[10000px] pb-[8277px] bg-white flex-col justify-start items-start inline-flex">
    ...
    <div class="self-stretch h-[600px] pl-[463px] pr-[464px] py-[19px] bg-purple-200 justify-center items-center inline-flex">
        <div class="self-stretch justify-start items-start gap-10 inline-flex">
            <div class="w-[408px] flex-col justify-start items-start gap-[72px] inline-flex">
    ...
    <div class="self-stretch h-[429px] pl-[463px] pr-[469px] py-[19px] bg-purple-200 justify-start items-center inline-flex">
        <div class="self-stretch justify-start items-start gap-[89px] inline-flex">
            <div class="w-[754px] h-[391px] justify-start items-start gap-10 flex">
                <div class="grow shrink basis-0 self-stretch flex-col justify-start items-start gap-10 inline-flex">
                    <div class="self-stretch h-28 text-black text-[80px] font-normal font-['Inter'] leading-[80px]">RSMPO</div>
                    <div class="self-stretch grow shrink basis-0 text-black text-[28px] font-normal font-['Inter'] leading-[33.60px]">Scruminc의 Registered Scrum Master 과정과 Registered Product Owner 인증 과정을 하나로 통합한 교육으로 Scrum Master의 역할과 Product Owner의 역할을 체험하고 RSM과 RPO의 듀얼 자격 인증을 취득한다.</div>
                </div>
            </div>
